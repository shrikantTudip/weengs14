<%@ Page Language="C#" AutoEventWireup="true" CodeFile="photogalary.aspx.cs" Inherits="photogalary" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Weengs 14::PhotoGalary</title>
...
<body>
   ...
   <div id="preload">
		...
		<center><img class="pr3" src="./img/photo_tran.png" alt="pre"/></center>
    </div>
    <div class="page">
    <div class="header">
