<%@ Page Language="C#" AutoEventWireup="true" CodeFile="twoauth.aspx.cs" Inherits="user_paper" %>
...
<body>
    ...
    <tr><td>
    <asp:TextBox ID="rname2" placeholder="Enter the name of member..." runat="server"></asp:TextBox>
    </td></tr><tr><td>
