<%@ Page Language="C#" AutoEventWireup="true" CodeFile="threeauth.aspx.cs" Inherits="user_threeauth" %>
...
<body>
    ...
    <tbody>    <tr><td>
    <asp:TextBox ID="rname1" placeholder="Enter the name of group leader..." runat="server"></asp:TextBox><asp:RequiredFieldValidator ID="RFV1" runat="server" ErrorMessage="Please Enter the name of group leader" ControlToValidate="rname1">*</asp:RequiredFieldValidator>
    </td></tr>
    <tr><td>
    ...
    <tr><td>
    <asp:TextBox ID="addr" placeholder="Enter the Address of group leader..." runat="server"></asp:TextBox><asp:RequiredFieldValidator ID="RFV2" runat="server" ErrorMessage="Please Enter the Address of group leader" ControlToValidate="addr">**</asp:RequiredFieldValidator>
    </td></tr><tr><td>
    ...
    <asp:TextBox ID="eid" placeholder="Enter the Email ID of group leader..." runat="server"></asp:TextBox><asp:RequiredFieldValidator ID="RFV4" runat="server" ErrorMessage="Please Enter the Email ID of group leader" ControlToValidate="eid">@</asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                ErrorMessage="Please Enter correct email id" ControlToValidate="eid" 
                ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*">@@</asp:RegularExpressionValidator>
    </td></tr><tr><td>
    <asp:TextBox ID="cont" placeholder="Enter the Contact No of group leader..." runat="server"></asp:TextBox><asp:RequiredFieldValidator ID="RFV5" runat="server" ErrorMessage="Please Enter the Contact No of group leader" ControlToValidate="cont">$</asp:RequiredFieldValidator>
    </td></tr><tr><td>
						            Gender(group leader's)
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal">
                    <asp:ListItem>Male</asp:ListItem>
                    <asp:ListItem>Female</asp:ListItem>
                        </asp:RadioButtonList><asp:RequiredFieldValidator ID="RequiredFieldValidator1" 
   ...
   <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label><br /><br />
        ...
        <tr><td> <asp:Label ID="Label2" runat="server" Text="Branch:"></asp:Label>&nbsp&nbsp&nbsp
