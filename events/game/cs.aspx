<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cs.aspx.cs" Inherits="events_game_cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Weengs14::Counter Strike</title>
...
<body>
   ...
   <div id="preload">
		...
		<center><img class="pr3" src="../../img/cs_tran.png" alt="pre"/></center>
    </div>
    <div class="page">
    <div class="header">
    ...
    <center>
       <img alt="Counter Strike" src="../../eventimg/cs-1.6.jpg" width="300" height="150"/>
       </center>
       <br /> Rules:
        <div style="padding-left:40px; font-style:normal; font-size:20px; font-weight:400; color:Yellow;">
        <ul>
        <li>Maximum five member per team.</li>
        <li>No cheats can be used</li>
        <li>participant can bring their own mouse and keyboard</li>
        <li>No change of team member will be allowed</li>
     ...
     <div style="text-align:center;">
        <asp:ImageButton ID="ImageButton1" runat="server" 
            ImageUrl="../../eventimg/button-copy.png" PostBackUrl="../../user/Default.aspx?event=cs" /></div>
    </div>
    </div>
    <div class="footer">
       <div id="bottomMenu">
