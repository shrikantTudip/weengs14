<%@ Page Language="C#" AutoEventWireup="true" CodeFile="boxcrik.aspx.cs" Inherits="events_game_boxcrik" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Weengs14::Box Cricket</title>
...
<body>
   ...
   <div id="preload">
		...
		<center><img class="pr3" src="../../img/box_tran.png" alt="pre"/></center>
    </div>
    <div class="page">
    <div class="header">
    ...
    <center>
       <img alt="Box cricket" src="../../eventimg/cricket-logo.jpg" width="300" height="150"/>
       </center>
       <br /> Rules:
        <div style="padding-left:40px; font-style:normal; font-size:20px; font-weight:400; color:Yellow;">
        <ul>
        <li>One Candidate per team.</li>
        <li>Maximum six no of players can play in team </li>
        <li>umpire decision is final</li>
        <li>All other rules are displayed before event</li>
    </ul>
    </div>
     <div style="text-align:left; padding-left:40px; font-size:30px; font-weight:300; color:Orange;">
       <br /> Entry Fees:&nbsp&nbsp <font color="yellow" size="10px">INR 400</font>
    </div>
     <div style="text-align:center;">
        <asp:ImageButton ID="ImageButton1" runat="server" 
            ImageUrl="../../eventimg/button-copy.png" PostBackUrl="../../user/Default.aspx?event=boxcrik" /></div>
    </div>
    </div>
    <div class="footer">
       <div id="bottomMenu">
