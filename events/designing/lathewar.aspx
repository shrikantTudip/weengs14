<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lathewar.aspx.cs" Inherits="events_lathewar" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>weengs14::Lathewar designing</title>
...
<body>
    ...
    <div id="preload">
		...
		<center><img class="pr3" src="../../img/lathe_tran.png" alt="pre"/></center>
    </div>
    <div class="page">
    <div class="header">
    ...
    <center>
       <img alt="LatheWar Designing" src="../../eventimg/lathew.jpg" width="300" height="150"/>
       </center>
       <br /> Rules:
        ...
        <li>job is given and have to complete within time </li>
        <li>Accuracy and time are evaluated for final decision</li>
        <li>Total three Rounds.</li>
     ...
     <div style="text-align:center;">
        <asp:ImageButton ID="ImageButton1" runat="server" 
            ImageUrl="../../eventimg/button-copy.png" PostBackUrl="../../user/Default.aspx?event=lathewar" /></div>
    </div>
    </div>
    <div class="footer">
       <div id="bottomMenu">
