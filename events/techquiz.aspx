<%@ Page Language="C#" AutoEventWireup="true" CodeFile="techquiz.aspx.cs" Inherits="events_techquiz" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Weengs14::Techno Quiz</title>
...
<body>
    ...
    <div id="preload">
		...
		<center><img class="pr3" src="../img/techno_tran.png" alt="pre"/></center>
    </div>
    <div class="page">
    <div class="header">
   ...
   <center> <div id="headerstrip" >
				...
				<table>
						<tr>
							<td ><a href="../Default.aspx" title="Home" style="margin-right:30px;">Home</a></td>
                  			<td onmouseover="showmenu('events')" onmouseout="hidemenu('events')">
                  			    <a href="Default.aspx" title="Events" style="margin-right:30px; padding-bottom:6px;color:#f20a13;text-shadow: 0px 0px 1px #f20a13;">Events</a>
                       		...
                       		<td><a href="../inspiration.aspx" title="Our Inspiration" style="margin-right:30px; padding-bottom:6px;">Our Inspiration</a></td>
                       		<td><a href="../motivation.aspx" title="Our Motivation" style="margin-right:30px; padding-bottom:6px;">Our Motivation</a></td>
                       		<td><a href="../oursponcers.aspx" title="Our Sponcers" style="margin-right:30px;padding-bottom:6px;">Our Sponcers</a></td>
    ...
    <center>
       <img alt="Techno Quiz" src="../eventimg/quiz.jpg" width="300" height="150"/>
       </center>
       <br /> Rules:
        <div style="padding-left:40px; font-style:normal; font-size:20px; font-weight:400; color:Yellow;">
        <ul>
        <li>Two Candidate per team.</li>
        <li>There were three rounds</li>
        <li>First round is general technical round</li>
        <li>In first round online test will be taken for their branch subjects</li>
        <li>Second round is on general knowledge and apptitude</li>
        <li>Third round is fastest fingure first</li>
     ...
     <div style="text-align:center;">
        <asp:ImageButton ID="ImageButton1" runat="server" 
            ImageUrl="~/eventimg/button-copy.png" PostBackUrl="~/user/Default.aspx?event=technoquiz" /></div>
    </div>
    </div>
    <div class="footer">
    <div id="bottomMenu">
