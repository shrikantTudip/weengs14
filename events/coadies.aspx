<%@ Page Language="C#" AutoEventWireup="true" CodeFile="coadies.aspx.cs" Inherits="events_coadies" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Weengs14::Coadies</title>
...
<body>
   ...
   <div id="preload">
		...
		<center><img class="pr3" src="../img/coadies_tran.png" alt="pre"/></center>
    </div>
    <div class="page">
    <div class="header">
   ...
   <center> <div id="headerstrip" >
    ...
    <center>
       <img alt="Coadies" src="../eventimg/codies.jpg" width="300" height="150"/>
       </center>
       <br /> Rules:
        <div style="padding-left:40px; font-style:normal; font-size:20px; font-weight:400; color:Yellow;">
        <ul>
        <li>One Candidate per team.</li>
        <li>Entry form will be collected from participant</li>
        <li>On evalution of form some of candidates are selected for further round</li>
        <li>The theme of this event is like roadies show on mtv</li>
        <li>judges dicision is final</li>
    </ul>
    </div>
     <div style="text-align:left; padding-left:40px; font-size:30px; font-weight:300; color:Orange;">
       <br /> Entry Fees:&nbsp&nbsp <font color="yellow" size="10px">INR 000</font>
    </div>
     </div>
    </div>
    <div class="footer">
