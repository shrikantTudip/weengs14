<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mechpaper.aspx.cs" Inherits="events_mechpaper" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Weengs14::Mech Paper</title>
...
<body>
   ...
   <div id="preload">
		...
		<center><img class="pr3" src="../../img/mech_tran.png" alt="pre"/></center>
    </div>
    <div class="page">
    <div class="header">
    ...
    <div style="text-align:left; padding-left:40px; font-size:30px; font-weight:300; color:Orange;">
       <br /><center>
       <img alt="Civil Paper Presentation" src="../../eventimg/mechp.jpg" width="300" height="150"/>
       </center>
       <br /> Subjects:
        <div style="padding-left:40px; font-style:normal; font-size:20px; font-weight:400; color:Yellow;">
        <ul>
        <li>Robotics and Automation</li>
        <li>Nuclear Power Potentials as major energy source</li>
        <li>CAD/CAM</li>
        <li>Smart Sensores & Transducers and related</li>
        <li>Advance Treads in Automobiles</li>
        <li>Advance Manufacturing System</li>      
        </ul>
        </div>
    </div>
     <div style="text-align:center;">
        <asp:ImageButton ID="ImageButton1" runat="server" 
            ImageUrl="~/eventimg/button-copy.png" PostBackUrl="~/user/Default.aspx?event=papermech" /></div>
    </div>
    <div class="footer">
       <div id="bottomMenu">
     <ul>
