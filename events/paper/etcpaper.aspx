<%@ Page Language="C#" AutoEventWireup="true" CodeFile="etcpaper.aspx.cs" Inherits="events_etcpaper" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Weengs14::ETC Paper</title>
...
<body>
    ...
    <div id="preload">
		...
		<center><img class="pr3" src="../../img/etc_tran.png" alt="pre"/></center>
    </div>
    <div class="page">
    <div class="header">
    ...
    <div style="text-align:left; padding-left:40px; font-size:30px; font-weight:300; color:Orange;">
       <br /><center>
       <img alt="Civil Paper Presentation" src="../../eventimg/etcp.jpg" width="300" height="150"/>
       </center>
       <br /> Subjects:
        <div style="padding-left:40px; font-style:normal; font-size:20px; font-weight:400; color:Yellow;">
        <ul>
        <li>Signal, Image, Video and Apllication(SIVA)</li>
        <li>VLSI & Embedded Computing</li>
        <li>Network & Communication(Zig-bee, Wireless, Microwave)</li>
        <li>Control And Automation</li>
        <li>Neural Network and fuzzy logics</li>
        <li>Mobile Multimedia communication</li>
       
        <li>Future Innovation technologies</li>
     ...
     <div style="text-align:center;">
        <asp:ImageButton ID="ImageButton1" runat="server" 
            ImageUrl="~/eventimg/button-copy.png" PostBackUrl="~/user/Default.aspx?event=paperetc" /></div>
    </div>
    <div class="footer">
       <div id="bottomMenu">
     <ul>
