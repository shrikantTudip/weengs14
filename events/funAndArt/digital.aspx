<%@ Page Language="C#" AutoEventWireup="true" CodeFile="digital.aspx.cs" Inherits="events_funAndArt_digital" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Weengs14::Digital Photography</title>
...
<body>
   ...
   <div id="preload">
		...
		<center><img class="pr3" src="../../img/dig_tran.png" alt="pre"/></center>
    </div>
    <div class="page">
    <div class="header">
    ...
    <center>
       <img alt="Digital Photography" src="../../eventimg/digitalPhotography.jpg" width="300" height="150"/>
       </center>
       <br /> Rules:
        <div style="padding-left:40px; font-style:normal; font-size:20px; font-weight:400; color:Yellow;">
        <ul>
        <li>One Candidate per team.</li>
        <li>One can send Max upto 3 photo copies</li>
        <li>Participant can send their photo at weengs14@gmail.com</li>
        <li>Participant should present and produce his/her photo at time of event</li>
     ...
     <div style="text-align:center;">
        <asp:ImageButton ID="ImageButton1" runat="server" 
            ImageUrl="../../eventimg/button-copy.png" PostBackUrl="../../user/Default.aspx?event=digitalphotography" /></div>
    </div>
    </div>
    <div class="footer">
       <div id="bottomMenu">
