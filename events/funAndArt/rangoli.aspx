<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rangoli.aspx.cs" Inherits="events_funAndArt_rangoli" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Weengs14::Rangoli</title>
...
<body>
   ...
   <div id="preload">
		...
		<center><img class="pr3" src="../../img/ran_tran.png" alt="pre"/></center>
    </div>
    <div class="page">
    <div class="header">
    ...
    <center>
       <img alt="Rangoli Contest" src="../../eventimg/Peacock-Rangoli.jpg" width="300" height="150"/>
       </center>
       <br /> Rules:
        <div style="padding-left:40px; font-style:normal; font-size:20px; font-weight:400; color:Yellow;">
        <ul>
        <li>One Candidate per team.</li>
        <li>one unit of rangoli</li>
        <li> participant should come with their own material</li>
        <li>college will not provide any material</li>
     ...
     <div style="text-align:center;">
        <asp:ImageButton ID="ImageButton1" runat="server" 
            ImageUrl="../../eventimg/button-copy.png" PostBackUrl="../../user/Default.aspx?event=rangoli" /></div>
    </div>
    </div>
    <div class="footer">
       <div id="bottomMenu">
