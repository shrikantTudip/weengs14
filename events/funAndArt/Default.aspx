<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="events_funAndArt_Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Weengs14::Fun And Art</title>
...
<body>
   ...
   <div id="preload">
		...
		<center><img class="pr3" src="../../img/fun_tran.png" alt="pre"/></center>
    </div>
    <div class="page">
    <div class="header">
                ...
                <table  align="left" >
                    <tr>
                        <td valign="top">
                                ...
                                <a target="_self" href="./digital.aspx">
                                    <div class="eve_boxes">
                                        
                                        <img alt="Digital Photography" src="../../eventimg/digital_photography.jpg" height="120px" width="201px" />
                                    </div>
                                </a>
                        </td>
                        <td>     
                                <a target="_self" href="./rangoli.aspx">
                                    <div class="eve_boxes">
                                        
                                        <img alt="Rangoli Contest" src="../../eventimg/rangoli-2.jpg" height="120px" width="201px" />
                                    </div>
                                </a>
                        </td>
                        <td>        
                                <a target="_self" href="./sketch.aspx">
                                    <div class="eve_boxes">
                                        
                                        <img alt="Pencil Sketch" src="../../eventimg/nature.jpg" height="120px" width="201px" />
                                    </div>
                                 </a>
                        </td>
