<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addzap.aspx.cs" Inherits="events_addzap" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Weengs14::ADDZAP</title>
...
<body>
    ...
    <div id="preload">
		...
		<center><img class="pr3" src="../img/add_tran.png" alt="pre"/></center>
    </div>
    <div class="page">
    <div class="header">
   ...
   <center> <div id="headerstrip" >
    ...
    <center>
       <img alt="Addzap" src="../eventimg/addzap.jpg" width="300" height="150"/>
       </center>
       <br /> Rules:
        <div style="padding-left:40px; font-style:normal; font-size:20px; font-weight:400; color:Yellow;">
        <ul>
        <li>One Candidate per team.</li>
        <li>Participant have to perform ad on given subject</li>
        
        <li>Judges dicision is final</li>
    </ul>
    </div>
     <div style="text-align:left; padding-left:40px; font-size:30px; font-weight:300; color:Orange;">
     ...
     <div style="text-align:center;">
        <asp:ImageButton ID="ImageButton1" runat="server" 
            ImageUrl="~/eventimg/button-copy.png" PostBackUrl="~/user/Default.aspx?event=addzap" /></div>
    </div>
    </div>
    <div class="footer">
    <div id="bottomMenu">
