<%@ Page Language="C#" AutoEventWireup="true" CodeFile="race.aspx.cs" Inherits="events_robo_race" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Weengs14::Robo Race</title>
...
<body>
    ...
    <div id="preload">
		...
		<center><img class="pr3" src="../../img/race_tran.png" alt="pre"/></center>
    </div>
    <div class="page">
    <div class="header">
    ...
    <center>
       <img alt="Robo Race" src="../../eventimg/race.jpg" width="300" height="150"/>
       </center>
       <br /> Rules:
        ...
        <li>Vehical remaining stationary more than 45 sec. gets Disqualified.</li>
    </ul>
    </div>
     <div style="text-align:left; padding-left:40px; font-size:30px; font-weight:300; color:Orange;">
     ...
     <div style="text-align:center;">
        <asp:ImageButton ID="ImageButton1" runat="server" 
            ImageUrl="../../eventimg/button-copy.png" PostBackUrl="../../user/Default.aspx?event=race" /></div>
    </div>
    </div>
    <div class="footer">
       <div id="bottomMenu">
