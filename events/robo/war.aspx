<%@ Page Language="C#" AutoEventWireup="true" CodeFile="war.aspx.cs" Inherits="events_robo_war" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Weengs14::Robo War</title>
...
<body>
    ...
    <div id="preload">
		...
		<center><img class="pr3" src="../../img/war_tran.png" alt="pre"/></center>
    </div>
    <div class="page">
    <div class="header">
    ...
    <center>
       <img alt="Robo War" src="../../eventimg/robot-wars1.jpg" width="300" height="150"/>
       </center>
       <br /> Rules:
     ...
     <div style="text-align:center;">
        <asp:ImageButton ID="ImageButton1" runat="server" 
            ImageUrl="../../eventimg/button-copy.png" PostBackUrl="../../user/Default.aspx?event=war" /></div>
    </div>
    </div>
    <div class="footer">
       <div id="bottomMenu">
