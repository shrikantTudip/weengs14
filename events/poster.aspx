<%@ Page Language="C#" AutoEventWireup="true" CodeFile="poster.aspx.cs" Inherits="events_poster_poster" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Weeng-14::Poster </title>
...
<body>
    ...
    <div id="preload">
		...
		<center><img class="pr3" src="../img/poster_tran copy.png" alt="pre"/></center>
    </div>
    <div class="page">
    <div class="header">
   ...
   <center> <div id="headerstrip" >
    ...
    <div style="text-align:left; padding-left:40px; font-size:30px; font-weight:300; color:Orange;">
       <br /><center>
       <img alt="Poster Presentation" src="../eventimg/poster.jpg" width="300" height="150"/>
       </center>
       <br /> 
        ...
        Rules:
        <ul>
        <li>Two Participants Per Group</li>
        <li>No Printed Poster Allowed</li>
        <li>Diagram cutting can be used on the poster</li>
        <li>Poster size is maximum 22"x28"</li>
        <li>Title will Appear on the top</li>
        <li>Conclusion Will Appear at lower right side</li>
        <li>Text should be readable from 5 feet away</li>
        </ul>
        </td>
        <td width="50%">
       Subjects:
        <ul>
        <li>Recent Advancement in Mechanical Engineering</li>
        <li>New Trends in IT and Computer Enginnering  </li>
        <li>New Trends in Electonics and Tele Communication Engineering</li>
        <li>New Trends in Electical Engineering</li>
        <li>New Trends in Civil Engineering</li>
        </ul>
        </td>
        </tr>
        </table>
        <hr />
    <div style="text-align:left; padding-left:40px; font-size:30px; font-weight:300; color:Orange;">
       Entry Fees:&nbsp&nbsp <font color="yellow" size="10px">INR 200</font>   
    </div>
        </div>
    </div>
     <div style="text-align:center;">
        <asp:ImageButton ID="ImageButton1" runat="server" 
            ImageUrl="~/eventimg/button-copy.png" PostBackUrl="~/user/Default.aspx?event=poster" /></div>
    </div>
    <div class="footer">
    <div id="bottomMenu">
     <ul>
