<%@ Page Language="C#" AutoEventWireup="true" CodeFile="blindc.aspx.cs" Inherits="events_programming_blindc" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Weengs 14::Blind C</title>
...
<body>
    ...
    <div id="preload">
		...
		<center><img class="pr3" src="../../img/blind_tran copy.png" alt="pre"/></center>
    </div>
    <div class="page">
    <div class="header">
    ...
    <center>
       <img alt="Civil Paper Presentation" src="../../eventimg/BLINDC.gif" width="300" height="150"/>
       </center>
       <br /> Rules:
     ...
     <div style="text-align:center;">
        <asp:ImageButton ID="ImageButton1" runat="server" 
            ImageUrl="../../eventimg/button-copy.png" PostBackUrl="../../user/Default.aspx?event=blindc" /></div>
    </div>
    </div>
    <div class="footer">
       <div id="bottomMenu">
