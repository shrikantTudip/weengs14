<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cadcivil.aspx.cs" Inherits="events_programming_cadcivil" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Weengs14::CAD For Civil</title>
...
<body>
    <form id="form1" runat="server">
     <div id="preload">
		...
		<center><img class="pr3" src="../../img/cadcivil.png" alt="pre"/></center>
    </div>
    <div class="page">
    <div class="header">
    ...
    CAD Programming contest
    </div>
    <br />
     <div style="text-align:left; padding-left:40px; font-size:30px; font-weight:300; color:Orange;">
    <center>
       <img alt="Civil Paper Presentation" src="../../eventimg/cdciv.jpg" width="300" height="150"/>
       </center>
       <br /> Rules:
     ...
     <div style="text-align:center;">
        <asp:ImageButton ID="ImageButton1" runat="server" 
            ImageUrl="../../eventimg/button-copy.png" PostBackUrl="../../user/Default.aspx?event=cadcivil" /></div>
    </div>
    </div>
    <div class="footer">
       <div id="bottomMenu">
