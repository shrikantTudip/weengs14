<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cadcam.aspx.cs" Inherits="events_programming_cadcam" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Weengs14::CAD/CAM Programming</title>
...
<body>
    ...
    <div id="preload">
		...
		<center><img class="pr3" src="../../img/cad_tran.png" alt="pre"/></center>
    </div>
    <div class="page">
    <div class="header">
    ...
    <center>
     ...
     <div style="text-align:center;">
        <asp:ImageButton ID="ImageButton1" runat="server" 
            ImageUrl="../../eventimg/button-copy.png" PostBackUrl="../../user/Default.aspx?event=cadcam" /></div>
    </div>
    </div>
    <div class="footer">
       <div id="bottomMenu">
